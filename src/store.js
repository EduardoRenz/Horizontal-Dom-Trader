...
export let min = writable(4380.5) // min price of the day
...
export let price_markers = writable({})
...
export const agressions = writable(
    [
        {agressor_id:"003",time:new Date('2020-08-29 09:30:01'),price:5381.0,ticks_consumed:1,lots:15,type:'sell'},
